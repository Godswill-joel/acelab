...
import { Facebook,  X , Linkedin, Phone, Mail } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div>
         <img src={ACE.src} alt="Acelab Logo" className="w-32 h-18 mb-5" />
          ...
          <p className="mt-6 text-gray-300 leading-relaxed text-xl">
            Ace Labview Limited is a leading provider of electrical technical
        ...
        <div>
          ...
          <p className="text-xl leading-relaxed mb-4">
            Office: No 2 Orji Close, Off Ada George Road, Port Harcourt
          </p>
